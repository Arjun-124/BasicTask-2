...
class GeneratorTest {
    ...
    void testGeneratorAlphabet() {
        assertEquals(firstAlphabet.getAlphabet(), generator.getAlphabet().getAlphabet());
    }

    @Test
    void testGeneratorAlphabetLength() {
        assertEquals(firstAlphabet.getAlphabet().length(), generator.getAlphabet().getAlphabet().length());
    }
}